<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		if (!$error) {
			...
			$res=mysql_query("SELECT facultyId, facultyEmail, facultyPass FROM faculty WHERE facultyName='$name'");
			$row=mysql_fetch_array($res);
			$count = mysql_num_rows($res);
			
			if( $count == 1 && $row['facultyPass']==$password ) {
    ...
    <div class="boxed">
    	...
    	<div class="col-md-12">
        	...
        	<div class="form-group">
            	<center><h2 class="">Faculty Page</h2></center>
