<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		if (!$error) {
			...
			$res=mysql_query("SELECT studentId, studentEmail, studentPass FROM student WHERE studentName='$name'");
...
<center><body background="student.jpg">
    ...
    <div class="boxed">
    	...
    	<div class="col-md-12">
        	...
        	<div class="form-group">
            	<center><h2 class="">Student Page</h2></center>
