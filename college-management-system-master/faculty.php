<?php
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
			...
			$query = "SELECT facultyEmail FROM faculty WHERE facultyEmail='$email'";
		...
		if( !$error ) {
			...
			$query = "INSERT INTO faculty(facultyName,facultyEmail,facultyPass) VALUES('$name','$email','$password')";
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
        	...
        	<div class="form-group">
            	<center><font size = "20"><h2 class="">Account for Faculty</h2></font></center>
            </div>
